"""
Correctness tests for the HCM fused complex-multiply Triton kernel.

_hcm_complex_mul computes stage 3 of the HCM FFT-conv -- the elementwise
product of the activation and filter spectra -- with stage 1's 1/fft_size
filter normalisation folded in. The oracle is the explicit torch expression
fftconv_func evaluates: u_f * (rfft(k) / fft_size).
"""
